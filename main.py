...
def main_screen():
    ...
    code=StringVar()
    Entry(textvariable=code,width=20,bd=0,font=("arial",25),show="*").place(x=10,y=210)

    Button(text="ENCRYPT",height="2",width="25",bg="#ed3833",fg="white",bd=0,command=encrypt).place(x=10,y=250)
    Button(text="DECRYPT",height="2",width="25",bg="#00bd56",fg="white",bd=0,command=decrypt).place(x=200,y=250)
    Button(text="RESET",height="2",width="52",bg="#1089ff",fg="white",bd=0,command=reset).place(x=10,y=300)
